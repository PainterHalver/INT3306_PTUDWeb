...
export default function MarkAsNeededToSendBackToSanxuat() {
  ...
  const confirmSend = async () => {
    try {
      await markAsReturnToSanxuat(selectedIds);
